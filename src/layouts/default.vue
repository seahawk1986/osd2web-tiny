<template>
  <v-app>
    <v-dialog v-model="isInitializing" fullscreen>
      <v-container class="fill-height ma-0 pa-0 ga-0" fluid no-gutters>
        <v-row align="center" justify="start" no-gutters>
          <v-col cols="12" md="4" no-gutters sm="8">
            <v-sheet
              class="d-flex justify-center align-center ma-0 pa-0 ga-0"
              height="100vh"
              width="100vw"
            >
              <v-container>
                <v-row align="center">
                  ...
                  <v-col
                    class="d-flex justify-center text-xs-center text-h2"
                    cols="12"
                  >
                    Waiting for osd2web …
                  </v-col>
