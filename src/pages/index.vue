<template>
  ...
  >
    ...
    <v-card-text class="ma-0 ga-0 pa-0">
      <v-img class="align-self-center" :src="`http://{{ location.hostname }}:4444/${store.DiashowData?.filename}`" /> <!-- TODO: this needs to explicitly point to the osd2web port only if the skin is not serverd by osd2web -->
    </v-card-text>
  </v-card>
  <v-card
