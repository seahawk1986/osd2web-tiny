        ...
        <v-col>
            <v-row class="d-flex justify-space-between align-center">
                ...
                <div class="d-flex justify-center align-center">
                    <v-icon
                        :color="rewindReplayColor"
                        icon="mdi-rewind"
                        size="60"
                    />
                    <v-icon
                        :color="playReplayColor"
                        :icon="props.isPlaying ? 'mdi-play' : 'mdi-pause'"
                        size="60"
                    />
                    <v-icon
                        :color="forwardReplayColor"
                ...
                <v-badge
                    :color="
                        props.numPendingTimers > 0 ? 'warning' : inactiveColor
                    "
                    :content="props.numPendingTimers"
                    inline
                >
                    <v-icon
                        :color="
                            props.numPendingTimers > 0
                                ? 'warning'
                                : inactiveColor
                        "
                ...
                <v-badge
                    color="warning"
                    :content="props.numNewRecordings"
                    inline
                >
                    <v-icon
                        :color="props.isRecording ? 'warning' : inactiveColor"
                        icon="mdi-record-rec"
                        size="60"
                    />
                </v-badge>
