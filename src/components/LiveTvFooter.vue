  ...
  <v-container fluid>
    <v-col>
      <v-row class="d-flex justify-space-between align-center">
        <CurrentTime />
        <v-icon
          :color="hasDolby ? 'warning' : 'grey-darken-3'"
          icon="mdi-audio-video"
          size="60"
        />
        <v-icon
          :color="hasMultiLang ? 'warning' : 'grey-darken-3'"
          icon="mdi-soundbar"
          size="60"
        />
        <v-icon
          :color="hasTeletext ? 'warning' : 'grey-darken-3'"
          icon="mdi-text-box-outline"
          size="60"
        />
        <v-icon
          :color="isEncrypted ? 'warning' : 'grey-darken-3'"
          icon="mdi-key-outline"
          size="60"
        />
        <v-badge
          :color="props.numPendingTimers > 0 ? 'warning' : 'grey-darken-3'"
        ...
        <v-badge color="warning" :content="props.numNewRecordings" inline>
          <v-icon
            :color="props.isRecording ? 'warning' : 'grey-darken-3'"
            icon="mdi-record-rec"
            size="60"
          />
        </v-badge>
